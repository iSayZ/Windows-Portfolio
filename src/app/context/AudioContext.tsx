...
export const AudioProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [audioElements, setAudioElements] = useState<Set<HTMLAudioElement>>(new Set());

  // Appliquer le volume à tous les éléments audio enregistrés
  const applyVolumeToAll = useCallback((newVolume: number) => {
...
export const useAudioElement = (audioRef: React.RefObject<HTMLAudioElement | null>) => {
